...
BOARD_MODEL_PATH = os.path.join(SRC_DIR, "competition", "model", "best.pt")
BOARD_ROW_COUNT = 14
BOARD_COL_COUNT = 10
BOARD_POINT_COUNT = BOARD_ROW_COUNT * BOARD_COL_COUNT
DEFAULT_DEBUG_PATH = os.path.expanduser("~/.ros/single_arm_tetris/托盘格点粗定位.jpg")
_board_model = None
